...
// Build filter/sort SQL for men's watches
$where = ['gender = "men"'];
$params = [];
$types = '';
...
<head>
    ...
    <title>Men's Watches | JackoTimespiece</title>
    ...
    <style>
        ...
        .men-hero::before {
            ...
            background: url('/assets/images/brand/men-bg.jpg') center/cover;
            opacity: 0.3;
            z-index: -1;
        }
...
<body class="bg-black text-white font-sans">
    ...
    <!-- Hero Section -->
    <section class="men-hero py-20 relative">
        <div class="container mx-auto px-6 text-center relative z-10">
            <h1 class="text-4xl md:text-6xl font-serif text-gold mb-6">Men's Collection</h1>
            <p class="text-xl text-gray-300 max-w-2xl mx-auto">
                Discover sophisticated timepieces designed for the modern gentleman. From classic elegance to contemporary style.
            </p>
        </div>
    </section>
    ...
    <main class="container mx-auto px-4 py-10 flex flex-col md:flex-row gap-10">
        ...
        <aside class="store-filter glass p-6 mb-8 md:mb-0 md:mr-8 rounded-2xl shadow-lg min-w-[220px] max-w-xs w-full">
            ...
            <form id="filter-form" method="GET" action="">
                ...
                <div class="flex gap-3">
                    ...
                    <a href="men.php" class="btn-gold px-5 py-2 rounded-md font-semibold shadow opacity-70">Reset</a>
                </div>
            </form>
        </aside>
        ...
        <section class="flex-1 w-full">
            ...
            <div class="flex flex-col md:flex-row md:items-center md:justify-between mb-8 gap-4">
                <div>
                    <h2 class="text-3xl md:text-4xl font-serif text-gold mb-2">Men's Watches</h2>
                    <p class="text-white text-lg opacity-80">Sophisticated timepieces for the discerning gentleman.</p>
                </div>
            ...
            <div class="store-products">
                <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-8">
                    ...
                    <?php
                        ...
                        echo '<p class="text-xl mb-2">No men\'s watches found</p>';
                        echo '<p class="text-gray-500">Try adjusting your filters or <a href="men.php" class="text-gold underline">view all men\'s watches</a></p>';
                        echo '</div>';
                    }
                    ?>
                </div>
